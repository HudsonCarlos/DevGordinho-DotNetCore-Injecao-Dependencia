...
namespace PagSeguro
{
    public partial class frPrincipal : Form
    {
        ...
        private const string pMeuEmail = ""; // Colque seu email de cadastro do PagSeguro aqui
        private const string pMeuToken = ""; // Coloque seu token de acesso do PagSeguro aqui
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            if (!sValidar.IsConnected())
            {
                MessageBox.Show("É necessário estar conectado à internet para gerar o pagamento!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Error);
