        ...
        public IEnumerable<Noticia> TodasAsNoticias()
        {
            var retorno = new Collection<Noticia>
            {
                ...
                new Noticia
                {
                    NoticiaId = 3,
                    Categoria = "Politica",
                    Titulo = "Vereador é eleito pela 4º",
                ...
                new Noticia
                {
                    ...
                    Conteudo = "Os comediantes mais engraçado dos comentários do Youtube fará show...",
                ...
                new Noticia
                {
                    ...
                    Conteudo = "O atacante Lucas Farias Santos Messi, fez 4 gols e decidiuo titulo...",
